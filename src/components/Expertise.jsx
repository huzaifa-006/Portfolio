...
const certLogos = {
  Coursera:
    "https://upload.wikimedia.org/wikipedia/commons/7/7e/Coursera_logo.svg",
...
export default function Expertise() {
  ...
  const projects = useSmoothCountUp(
    12,
    600,
    revealed || hoveredStat === "projects"
  );
      ...
      <div className="container">
        ...
        <div className="row justify-content-center g-4">
          {skillGroups.map((group, gIdx) => (
            <div
              key={gIdx}
              className="col-md-6 col-lg-3 d-flex section-fade-in"
            >
              <div
          ...
          {[
            {
              ...
              org: "Coursera",
              year: 2025,
              link: "https://www.coursera.org/account/accomplishments/verify/UF5QZD4NNCFT",
            },
            {
              title: "Python data Structures",
              org: "Coursera",
              year: 2025,
              link: "https://www.coursera.org/account/accomplishments/verify/K59SRACBNL42",
            },
            {
              title:
              ...
              org: "IBM",
              year: 2025,
              link: "https://www.coursera.org/account/accomplishments/verify/KRQ7QTRZ4XIZ",
            },
            {
              title: "React.js Essential Training",
              org: "LinkedIn Learning",
              year: 2024,
              link: "https://www.linkedin.com/learning/certificates/6fdcb5df18e3d536a2c5c78558b06a12850bff5cee99e44c28906687f44790b4",
            },
            {
              title: "Advanced Features of Java 21",
              org: "LinkedIn Learning",
              year: 2024,
              link: "https://www.linkedin.com/learning/certificates/618a76e65489bd02f7c7c801961b119ec1599e482b16d8b23cf0a8b3713e09cc",
            },
            {
              title: "React Essential Training",
              org: "LinkedIn Learning",
              year: 2023,
              link: "https://www.linkedin.com/learning/certificates/216495fe98d0d5b21dc38dcfdb7c622e7da840649d1a16a902bd65a82912f7a1",
            },
          ].map((cert, idx) => (
                  ...
                  <img
                    src={
                      idx === 0 || idx === 1
                        ? courseraLogo
                        : certLogos[cert.org] ||
                          "https://via.placeholder.com/36x36?text=Logo"
                    }
                    onError={(e) => {
                      if (idx === 0 || idx === 1)
                        e.target.src = courseraLogoDataUri;
                    }}
                    alt={cert.org + " logo"}
                    className="cert-logo"
                  />
